	...
	<div class="col-xs-12 eqLogicThumbnailDisplay">
        ...
        <div class="eqLogicThumbnailContainer">
            ...
            <div class="cursor eqLogicAction logoSecondary" data-action="createCommunityPost">
              <i class="fas fa-life-ring" style="color:#00A9EC"></i>
              <br>
              <span>{{Support Forum}}</span>
            </div>
		</div>

    	<legend><i class="fas fa-table"></i> {{Mes télécommandes}}</legend>
		<?php
        if (count($eqLogics) == 0) {
            echo '<br><div class="text-center" style="font-size:1.2em;font-weight:bold;">{{Aucun équipement télécommande trouvé, cliquer sur "Ajouter" pour commencer}}</div>';
        } else {
...
?>
			...
			<div role="tabpanel" class="tab-pane" id="infocmd">
				...
				<div id="tab_custom">
					<a class="btn btn-success btn-sm cmdAction pull-left" data-action="addCmdMulti" style="margin-top:5px;"><i class="fas fa-plus-circle"></i> {{Commandes}}</a><br/><br/>
